...
import PendingQuotesDetail from './PendingQuotesDetail';
import PendingRecommendationsDetail from './PendingRecommendationsDetail';
...
const PendingQuoteDetail = (props: PropData) => {
    ...
    const getCancelledCallsDetail = () => {
        ...
        setShowLoader(true)
        WebService.postAPI({
            action: `SaiUserWidget/GetPendingQuotesAndRecommendationsData`,
            body: requestBody,
        })
            .then((res: any) => {
                setShowLoader(false);
                        ...
                        <Tab
                            ...
                            title={
                                <div className="d-flex flex-column justify-content-center align-items-center">
                                    <label className="nav-text">Quotes</label>
                                </div>
                            }

                        >
                            <PendingQuotesDetail data={pendingData && pendingData?.PendingQuotes && pendingData?.PendingQuotes} showLoader={showLoader}/>
                        </Tab>
                        <Tab eventKey="Recommendation"
                            title={
                                <div className="d-flex flex-column justify-content-center align-items-center">
                                    <label className="nav-text">Recommendation</label>
                                </div>
                            }

                        >
                            <PendingRecommendationsDetail data={pendingData && pendingData?.OpenRecommendations && pendingData?.OpenRecommendations} showLoader={showLoader}/>
                        </Tab>
...
export default PendingQuoteDetail;
