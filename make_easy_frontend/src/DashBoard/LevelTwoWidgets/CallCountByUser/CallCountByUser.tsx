...
const CallCountByUser = (props: PropData) => {
    ...
    const formatData = (): Chart.ChartData => ({
        labels: ["Anushka Chavan", "Base User", "Portal"],
        datasets: [
            {
                data: salesData, backgroundColor: "#9FA62C", label: "Count", categoryPercentage: 0.5,
                barPercentage: 0.80
            }]
    });
                            ...
                            <>
                                <div className="d-flex justify-content-between">
                                    <div className='d-flex justify-content-between dropdown-div'>
                                        <p className="name">Call Count By User</p>
...
export default CallCountByUser;