    ...
    const canvasCallback = (canvas: HTMLCanvasElement | null) => {
        ...
        if (ctx) {
            chartRef.current = new Chart(ctx, {
                type: "horizontalBar",
                data: {
                    labels: ['Tori hagedom', 'Grauls Market', 'Jupitor Company', 'Michael Brace', '1778 McDonald’s #7499'],
                    datasets: [
                        {
                            data: [90000, 82000, 25000, 20000, 45000],
                            ...
                            <>
                                <div className="d-flex justify-content-between">
                                    <div className='d-flex justify-content-between dropdown-div'>
                                        <p className="name">Top 5 AR Balance</p>
                                    </div>
...
export default TopFiveARBalance;