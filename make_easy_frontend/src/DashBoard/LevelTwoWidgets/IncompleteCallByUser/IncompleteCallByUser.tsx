...
import './IncompleteCallByUser.scss';
...
const IncompleteCallByUser = (props: PropData) => {
    ...
    const [salesData, setSalesData] = useState([30,50,10]);
    ...
    const formatData = (): Chart.ChartData => ({
        labels: ["DNS", "ggfffgfgf", "INC","NH","NP","PO","Test"],
        datasets: [
            {
                data: salesData, backgroundColor: "#FF6921", label: "Count", categoryPercentage: 0.5,
                barPercentage: 0.50
            }]
    });
                            ...
                            <>
                                <div className="d-flex justify-content-between">
                                    <div className='d-flex justify-content-between dropdown-div'>
                                        <p className="name">Incomplete Calls</p>
                                ...
                                <div className="d-flex justify-content-between">
                                    <div className="d-flex ms-3">
                                        ...
                                        <div className="date">{topCustometData?.Filter && moment(topCustometData?.Filter?.FromDate, 'YYYY-MM-DD hh:mm:ss').format('MMM DD,YY')} - {topCustometData?.Filter && moment(topCustometData?.Filter?.ToDate, 'YYYY-MM-DD hh:mm:ss').format('MMM DD,YY')}Dec 17, 22 - Feb 15, 23</div>
                                    </div>
...
export default IncompleteCallByUser;