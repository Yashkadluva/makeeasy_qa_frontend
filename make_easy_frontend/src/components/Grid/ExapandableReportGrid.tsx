...
import Grid, { GridHeader, Filter, FilterOption, GridRow } from "./Grid";

export interface ExpandableData {
    headers: GridHeader[];
    expandableHeader: GridHeader[];
    rows: ExpandableRow[];
    filters?: Filter[];
    ShowLoader?: boolean;
    errorMessage?: string;
...
const ExpandableReportGrid = (props: ExpandableData) => {
                                ...
                                return (
                                    <>
                                        ...
                                        >
                                            ...
                                            {expandableRow.header.length > 0 && expandableRow?.header?.map((res: any) => {
                                                return (
                                                    <td>
                                                        {res.value}
                                                    </td>
                                        ...
                                        </tr>
                                        {
                                            ...
                                            <tr>
                                                <td></td>
                                                <td colSpan={expandableRow.header.length} style={{borderLeft:"none"}}>
                                                    <Grid
                                                        headers={props.expandableHeader}
                                                        rows={expandableRow.data}
                                                    />
                                                </td>
                                            </tr>
                                        }
                                        {/* <div>
                                            {
                                                expandableRow.isExpand && props.expandableHeader.map((header: GridHeader, i: any) => {
                                                    return (
                                                        <th
                                                            className={
                                                                "cursor-pointer text-center " +
                                        ...
                                        {/* {expandableRow.isExpand && expandableRow.data.map((row: GridRow, i) => (
                                            <>
                                                {
                                                    props.expandableHeader.map((header: GridHeader, j: any) =>
                                                        header.isShow === false ? (
                                                            ""
                                                        ) : (
                                                            <td
...
export default ExpandableReportGrid;
